...
//#region node_modules/vanta/dist/vanta.net.min.js
var require_vanta_net_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(t, e) {
		...
		function s(t, e) {
			return t ??= 0, e ??= 1, Math.floor(t + Math.random() * (e - t + 1));
		}
		t.r(e), t.d(e, { default: () => u }), Number.prototype.clamp = function(t, e) {
		...
		a.VantaBase = class {
			constructor(t = {}) {
				...
				if (this.options = Object.assign({
					...
					scale: 1,
					scaleMobile: 1
				}, e), (t instanceof HTMLElement || "string" == typeof t) && (t = { el: t }), Object.assign(this.options, t), this.options.THREE && (h = this.options.THREE), this.el = this.options.el, null == this.el) l("Instance needs \"el\" param!");
				...
				try {
					...
					l("Init error", t), this.renderer && this.renderer.domElement && this.el.removeChild(this.renderer.domElement), this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = (s = this.options.backgroundColor, "number" == typeof s ? "#" + ("00000" + s.toString(16)).slice(-6) : s));
					return;
				}
		...
		class d extends c {
			...
			genPoint(t, e, i) {
				...
				if (this.points || (this.points = []), this.options.showDots) {
					const t = new p.SphereGeometry(.25, 12, 12), e = new p.MeshLambertMaterial({ color: this.options.color });
					s = new p.Mesh(t, e);
