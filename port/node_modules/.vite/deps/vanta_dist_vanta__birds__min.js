...
//#region node_modules/vanta/dist/vanta.birds.min.js
var require_vanta_birds_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		...
		r.VantaBase = class {
			constructor(e = {}) {
				...
				if (this.options = Object.assign({
					...
					scale: 1,
					scaleMobile: 1
				}, t), (e instanceof HTMLElement || "string" == typeof e) && (e = { el: e }), Object.assign(this.options, e), this.options.THREE && (s = this.options.THREE), this.el = this.options.el, null == this.el) a("Instance needs \"el\" param!");
				...
				try {
					...
					a("Init error", e), this.renderer && this.renderer.domElement && this.el.removeChild(this.renderer.domElement), this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = (n = this.options.backgroundColor, "number" == typeof n ? "#" + ("00000" + n.toString(16)).slice(-6) : n));
					return;
				}
		...
		const l = r.VantaBase;
		let { Camera: c, ClampToEdgeWrapping: d, DataTexture: u, FloatType: p, Mesh: m, NearestFilter: f, PlaneBufferGeometry: v, RGBAFormat: y, Scene: g, ShaderMaterial: w, WebGLRenderTarget: b } = "object" == typeof window && window.THREE || {};
		const x = function(e, t, i, n) {
			...
			r.position.z = 1;
			var a = { passThruTexture: { value: null } }, l = T("uniform sampler2D passThruTexture;\n\nvoid main() {\n\n	vec2 uv = gl_FragCoord.xy / resolution.xy;\n\n	gl_FragColor = texture2D( passThruTexture, uv );\n\n}\n", a), h = new m(new v(2, 2), l);
			function x(i) {
