  ...
  return (
    <nav 
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        isScrolled 
          ? 'bg-white/70 dark:bg-[#08080a]/70 backdrop-blur-md border-b border-slate-200/40 dark:border-slate-900/40 py-4 shadow-sm' 
          : 'bg-transparent py-6'
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-12 flex items-center justify-between">
        ...
        <a 
          href="#about" 
          className="text-lg font-bold font-display tracking-tight text-slate-900 dark:text-white group flex items-center gap-1"
        >
          <span>Himanshu</span>
        ...
        <div className="flex items-center space-x-8 sm:space-x-10">
          ...
          {/* Social Platform Icon Links (High-Performance SVG Integration) */}
          <div className="flex items-center space-x-4 pl-6 border-l border-slate-200/60 dark:border-slate-800/60">
            {/* GitHub Link */}
            <a 
              ...
              className="p-2 rounded-lg text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-900/60 transition-all duration-200 hover:scale-105"
            >
